...
export const PRODUCT_DEFINITIONS = [
  ...
  { code: "3004", name: "Team Uniform", category: "Sportswear", fabric: "Dry Fit", gsm: "160 GSM", imageFile: "tu1 (1).png", features: ["Moisture Wicking", "Breathable"], idealUsage: ["Sports Teams", "Events"] },

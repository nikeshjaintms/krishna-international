...
import { customizationOptions, processSteps } from "@/data/mockData";
        ...
        >
          ...
          >
            ...
            <div className="relative h-56 bg-zinc-100">
              <Image src={learnMoreOption.img} fill sizes="(max-width: 768px) 100vw, 672px" alt={learnMoreOption.title} className="object-cover" />
